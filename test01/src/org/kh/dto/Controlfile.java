...
public class Controlfile {
	...
	public Controlfile() {}
	public Controlfile(String name, String is_recovery_dest_file, int block_size, int file_size_blks,
			int con_id) {
		super();
		this.name = name;
	...
	public String toString() {
		return "Controlfile [name=" + name + ", is_recovery_dest_file=" + is_recovery_dest_file
				+ ", block_size=" + block_size + ", file_size_blks=" + file_size_blks + ", con_id=" + con_id + "]";
	}
